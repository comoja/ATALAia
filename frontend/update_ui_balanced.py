...
print("Updated aetherial-ui.css with balanced proportions (34px height)!")
...
dash = dash.replace(
    ...
    'style="padding: 8px 12px; background: rgba(241, 245, 249, 0.6); border: 1px solid #e2e8f0; border-radius: 8px; display: flex; align-items: center; justify-content: space-between;"'
)
...
print("Updated dashboard.xhtml with balanced proportions (34px height)!")
