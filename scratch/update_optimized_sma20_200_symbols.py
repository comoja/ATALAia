...
def updateOptimizedSMA20200Symbols():
    csvPath = "/Volumes/TimeMachine/ATALAia/Sentinel/backtesting/sma20_200_grid_results_best.csv"
    strategyName = "SMA20_200"
    ...
    try:
        ...
        # Asegurar que strategyConfig tenga insertada la estrategia SMA20_200 y esté habilitada
        cursor.execute("""
        ...
        if not dfBest.empty:
            for _, row in dfBest.iterrows():
                ...
                params = {
                    "slopeThreshold": float(row['slopeThreshold']),
        ...
        conn.commit()
        logger.info("🎉 Proceso de actualización de parámetros SMA20_200 finalizado con éxito.")
...
if __name__ == "__main__":
    updateOptimizedSMA20200Symbols()
