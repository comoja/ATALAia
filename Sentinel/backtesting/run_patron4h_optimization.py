                ...
                for displacementPct in displacementPctCombos:
                    for fvgMinPct in fvgMinPctCombos:
                        ...
                        while idx < n:
                            ...
                            # Filtro rápido: si ninguna vela cerrada recientemente tiene catalizador, saltar
                            ...
                            try:
                                # Ejecutar análisis de Patron4h con tiempo simulado
