...
new_engine_with_subtotal_rows = '''    # =========================================================================
    # 7. BACKTESTING DE TODAS LAS SEÑALES CON FILAS DE SUBTOTALES POR CIERRE
    # =========================================================================
    def runSignalBacktest(
        ...
        """
        Ejecuta el backtest asignando un 20% del capital en cada entrada e inyecta
        filas de subtotales para cada fecha de cierre de posiciones (círculo ●).
        """
...
print("Updated quant_pair_engine.py with direct subtotal rows!")
