...
new_engine_15pct = '''    # =========================================================================
    # 7. BACKTESTING DE TODAS LAS SEÑALES GRÁFICAS CON ASIGNACIÓN DEL 15% POR TRADE
    # =========================================================================
    def runSignalBacktest(
        ...
        allocationPct: float = 15.0, # 15% por entrada (7.5% Par A + 7.5% Par B)
        commissionBps: float = 2.0,
        slippageBps: float = 1.0
    ) -> Dict[str, Any]:
        """
        Ejecuta el backtest asignando un 15% del capital de la cuenta en cada entrada
        (7.5% en Par A y 7.5% en Par B) para permitir hasta 6 entradas simultáneas escalonadas.
        """
        ...
        for i in range(1, n):
            ...
            # 2. EVALUAR NUEVA SEÑAL DE ENTRADA (CON 15% DE CAPITAL)
...
print("Updated quant_pair_engine.py with 15% allocation per trade!")
