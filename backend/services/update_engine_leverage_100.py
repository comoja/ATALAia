...
new_engine_with_leverage = '''    # =========================================================================
    # 7. BACKTESTING CON APALANCAMIENTO 1:100 Y CAPITAL REAL DE CUENTA
    # =========================================================================
    def runSignalBacktest(
        ...
        leverage: float = 100.0,     # Apalancamiento 1:100 institucional
        ...
        """
        Ejecuta el backtest utilizando el capital real de la cuenta seleccionada
        (cuenta.Capital) y apalancamiento promedio 1:100, asignando el 20% en margen
        (10% Par A + 10% Par B) en múltiplos enteros de symbols.min_lots.
        """
        ...
        for i in range(1, n):
            ...
            # Calcular PnL no realizado de todos los trades activos con apalancamiento
            ...
            # 2. EVALUAR ENTRADA (20% DE MARGEN CON APALANCAMIENTO 1:100 EN MÚLTIPLOS DE symbols.min_lots)
            ...
            if sigType and direction:
                ...
                # Margen requerido por 1 lote mínimo con apalancamiento 1:100
...
print("Updated quant_pair_engine.py with leverage 1:100 and cuenta.Capital integration!")
