...
from middleware.api import analysisRouter
...
app.include_router(analysisRouter.router, prefix="/api/v1", tags=["Analysis"])
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("backend.main:app", host="0.0.0.0", port=8004, reload=False)
